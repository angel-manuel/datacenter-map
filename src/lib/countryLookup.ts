// Maps ISO 3166-1 numeric codes (used in TopoJSON) to ISO 3166-1 alpha-2 codes
// Used to link country polygons with datacenter country_code field
const numericToAlpha2: Record<string, string> = {
  '004': 'AF', '008': 'AL', '012': 'DZ', '016': 'AS', '020': 'AD',
  '024': 'AO', '028': 'AG', '032': 'AR', '036': 'AU', '040': 'AT',
  '044': 'BS', '048': 'BH', '050': 'BD', '051': 'AM', '056': 'BE',
  ...
  '887': 'YE', '894': 'ZM',
  // Kosovo (not in ISO standard but in TopoJSON)
  '-99': 'XK',
};

export function numericToAlpha2Code(numericId: string): string | undefined {
  return numericToAlpha2[numericId];
}

export function getCountryCodesWithDatacenters(countryCodes: string[]): Set<string> {
